...
model = YOLO("deettection.pt", weights_only=False)  # Replace with your trained model name in root dir
...
if uploaded_image:
    ...
    size_map = {"S": (0, 1200), "M": (1201, 3000), "L": (3001, float("inf"))}  # Adjusted for better accuracy
    ...
    for i, box in enumerate(boxes):
        ...
        size_class = "L" if bbox_area > 3000 else "M" if bbox_area > 1200 else "S"
